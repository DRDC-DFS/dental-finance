...
<div class="container-fluid py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Tambah Treatment</h4>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('master.treatments.store') }}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           required
                           maxlength="150"
                           placeholder="Contoh: Scaling, Tambal GIC, Cabut Gigi, Bridge, Implan, dll">
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="price_mode" id="price_mode" class="form-select" required>
                            <option value="fixed" {{ old('price_mode', 'fixed') === 'fixed' ? 'selected' : '' }}>Harga Tetap</option>
                            <option value="manual" {{ old('price_mode') === 'manual' ? 'selected' : '' }}>Harga Manual</option>
                        </select>
                        <div class="form-text">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text"
                               ...
                               placeholder="150.000">
                        <div class="form-text" id="price_help_text">
                            Gunakan titik. Contoh: 150.000 atau 1.500.000
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               maxlength="30"
                               placeholder="Contoh: 1x / per gigi / paket">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input"
                               ...
                               id="allow_zero_price"
                               value="1"
                               {{ old('allow_zero_price') == '1' ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="notes_hint"
                              ...
                              rows="2"
                              maxlength="1000"
                              placeholder="Contoh: Isi harga final manual sesuai jumlah unit, bahan, dan detail kasus pasien">{{ old('notes_hint') }}</textarea>
                    <div class="form-text">
                        Khusus berguna untuk treatment dengan harga manual seperti Bridge, Implan, Gigi Tiruan Lepasan, atau Retainer.
                    </div>
                </div>

                <div class="alert alert-info mb-3" id="manual_price_alert" style="display: none;">
                ...
                <div class="alert alert-warning mb-3" id="zero_price_alert" style="display: none;">
                ...
                <div class="alert alert-success mb-3" id="free_treatment_alert" style="display: none;">
                ...
                <div class="text-muted small mb-3">
                    Setiap dokter aktif memiliki pengaturan fee sendiri. Ini membuat perhitungan lebih jelas jika dokter mitra atau tamu lebih dari satu orang.
                </div>
                ...
                @php
                    ...
                    $feeDefaultsByDoctor = $feeDefaultsByDoctor ?? [];
                @endphp
                        ...
                        <tbody>
                            @forelse($doctors as $doctor)
                                @php
                                    ...
                                    $defaultFeeType = old("doctor_fees.$doctorId.fee_type", $feeDefaultsByDoctor[$doctorId]['fee_type'] ?? 'manual');
                                    $defaultFeeValue = old("doctor_fees.$doctorId.fee_value", $feeDefaultsByDoctor[$doctorId]['fee_value'] ?? '0');
                                @endphp
                                <tr>
                                    <td>
...
(function () {
    ...
    function togglePriceModeUI() {
        ...
        if (isManual) {
            ...
            priceEl.removeAttribute('readonly');
            priceEl.classList.remove('bg-light');
            priceEl.placeholder = '150.000';
            if (priceHelpTextEl) {
                priceHelpTextEl.textContent = 'Gunakan titik. Contoh: 150.000 atau 1.500.000';
            }
            if (manualAlertEl) {
