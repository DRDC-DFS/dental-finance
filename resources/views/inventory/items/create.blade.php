...
@php
    ...
    $selectedType = old('type', 'barang');
    $selectedUnit = old('unit', 'pcs');
    $selectedMinimumStock = old('minimum_stock', 0);
@endphp

<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
    <div>
        <h4 class="mb-0">Tambah Item Inventory</h4>
        <div class="text-muted small">Tambahkan master item baru untuk digunakan pada inventory masuk, keluar, dan laporan stok.</div>
    </div>
        ...
        <form method="POST" action="{{ route('inventory.items.store') }}">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="form-text">Contoh: Cotton roll, etching gel, sarung tangan, mirror, dan lain-lain.</div>
                </div>
